...
import com.example.activitytest.ImageProcessing;
...
public class FourthActivity extends Activity {
    ...
    private static TextView mTV_Running_Level = null;
    ...
    private void initConfig() {
        ...
        mTV_Running_Level = (TextView) findViewById(R.id.id_tv_running_level);
    ...
    private void updateChart() {
        ...
        if(flag == 1) {
            ...
            if(gx < 200){
                if(hua[20] > 1){
                    Toast.makeText(FourthActivity.this, "请用指尖盖住摄像头镜头！", Toast.LENGTH_SHORT).show();
                    hua[20] = 0;
                }
                hua[20]++;
                return;
    ...
    private static PreviewCallback previewCallback = new PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (totalTimeInSecs >= 2) {
                ...
                String hr="心率:"+String.valueOf(beatsAvg);
                String rl;
                if(beatsAvg<120) {
                    rl="运动强度:低";
                }
                else if(beatsAvg<=150){
                    rl="运动强度:中";
                }
                else{
                    rl="运动强度:高";
                }
                mTV_Heart_Rate.setText(hr);
                mTV_Running_Level.setText(rl);
                //获取系统时间（ms）
                startTime = System.currentTimeMillis();
                beats = 0;
            }
